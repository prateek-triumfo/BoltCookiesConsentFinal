                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.consent.categories.update', $category) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('key') is-invalid @enderror" id="key" name="key" value="{{ old('key', $category->key) }}" required>
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="is_required" name="is_required" value="1" {{ old('is_required', $category->is_required) ? 'checked' : '' }}>
