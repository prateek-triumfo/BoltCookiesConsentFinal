                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($user->role)
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $user->role->slug === 'admin' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                                    {{ $user->role->name }}
                                                </span>
                                            @else
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-900">
                                                ...
                                                @empty
                                                    <span class="text-gray-500">No domains assigned</span>
                                                @endforelse
                                            </div>
                                        </td>
